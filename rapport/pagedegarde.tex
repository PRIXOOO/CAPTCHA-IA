...
%\AddToShipoutPicture*{\EtiquetteThese}
  ...
  \centering
   ...
   $\ $\\
    ...
    % --- AJOUT GITHUB ET CLE GEMINI ---
    \vspace{0.5cm}
    \textbf{Github :} \href{https://github.com/PRIXOOO/CAPTCHA-IA}{PRIXOOO/CAPTCHA-IA: A Captcha using LLM} \\
    (\url{https://github.com/PRIXOOO/CAPTCHA-IA}) \\
    \vspace{0.2cm}
    \textbf{Clé Gemini :} \texttt{CLE TRANSMISE SUR COURSENLIGNE}
    
    \texttt{(pour des raisons de sécurité je ne vais pas transmettre ma clé sur un dépot publique)}
    % ----------------------------------
